...
const values = [
  {
    ...
    description: "We live here, we work here, and we know Austin inside and out. From the best neighborhoods to the hidden parks, we share our local knowledge with every client.",
    icon: (
  ...
  },
  {
    ...
    description: "Your goals are our goals. Whether you're buying your dream home or investing in rental property, we tailor our approach to your unique needs.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function AboutPage() {
  ...
  return (
    <>
      <SEOPageHero
        title="About Birdsong Realty Team"
        subtitle="Your trusted partners in Austin real estate since 2009"
        backgroundImage="/images/hero/austin-zilker-park.jpg"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-fluid-3xl font-display font-semibold text-neutral-900 tracking-tight mb-6">
                Helping You Find Home in Austin, Texas
              </h2>
              <div className="prose prose-lg text-neutral-600">
                <p>
                  Birdsong Realty Team was founded with a simple mission: to help people discover the
                  magic of living in Austin, Texas. What started as a passion for
                  this vibrant city has grown into a full-service real estate team dedicated to making
                  your Austin dreams a reality.
                </p>
                <p>
                  Over the years, we've helped hundreds of families find their perfect home,
                ...
                <p>
                  Whether you're searching for a lakefront estate, a charming Hill Country home, or a
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg text-primary-200 mb-8">
              ...
              schedule showings, and help you find your perfect Austin property.
            </p>
