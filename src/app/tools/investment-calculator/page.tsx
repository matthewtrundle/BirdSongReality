  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Analyze rental returns for Austin investment properties"
              ...
              <div className="bg-white rounded-xl shadow-sm border border-neutral-100 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-neutral-500 mt-1">
                      Austin long-term rentals average 90-95% occupancy; STRs vary
                    </p>
                  </div>
                </div>
              </div>
      ...
      <Container>
        <CTABanner
          ...
          description="Let us help you find the perfect investment property in Austin"
