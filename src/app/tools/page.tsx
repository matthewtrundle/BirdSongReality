...
export const metadata: Metadata = {
  title: "Real Estate Tools & Calculators | Birdsong Realty Team",
  description:
    "Free real estate tools and calculators for Austin buyers and sellers. Mortgage calculator, home value estimator, investment ROI calculator, and more.",
  keywords: [
    "mortgage calculator Austin",
    "home value estimator Austin TX",
    "real estate investment calculator",
    "Austin property tools",
  ],
}
...
const tools = [
  {
    ...
    description:
      "Calculate your monthly mortgage payment, including principal, interest, taxes, and insurance for Austin properties.",
  ...
  },
  {
    ...
    description:
      "Get an estimated value for your Austin property based on local market data and comparable sales.",
  ...
  },
  {
    ...
    description:
      "Estimate your closing costs when buying a property in Austin, including taxes, insurance, and fees.",
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Free calculators and tools to help you make informed decisions about Austin real estate"
