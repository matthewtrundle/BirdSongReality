  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Find out how much home you can afford in Austin"
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-500 mt-1">
                    Austin properties typically require $3,000-$6,000+ annually
                  </p>
                </div>
              </div>
            </div>
      ...
      <Container>
        <CTABanner
          ...
          description="Let us help you find Austin properties within your price range"
