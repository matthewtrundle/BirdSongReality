  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Compare the true costs of renting versus buying in Austin"
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-accent-50 border border-accent-200 rounded-xl p-6">
                ...
                <p className="text-sm text-neutral-600 mb-4">
                  Explore Austin properties and start building equity.
                </p>
      ...
      <Container>
        <CTABanner
          ...
          description="Speak with our team about buying vs renting in Austin"
