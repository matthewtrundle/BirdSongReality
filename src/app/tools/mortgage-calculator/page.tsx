...
export default function MortgageCalculatorPage() {
  ...
  const [propertyTax, setPropertyTax] = useState(2.0) // % of home value
  const [insurance, setInsurance] = useState(4000) // Annual
  const [hoa, setHoa] = useState(200) // Monthly
  ...
  const breakdownData = [
    ...
    { label: "Insurance", value: calculations.monthlyInsurance, color: "bg-highlight-500" },
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Calculate your monthly mortgage payment for Austin properties"
        ...
        <Container>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-500 mt-1">
                    Austin properties typically require $3,000-$6,000/year in homeowners insurance
                  </p>
                </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-primary-50 border border-primary-200 rounded-xl p-6">
                ...
                <p className="text-sm text-neutral-600 mb-4">
                  Get pre-approved and start your Austin home search.
                </p>
          ...
          <div className="mt-8 p-4 bg-neutral-100 rounded-lg">
            <p className="text-xs text-neutral-500">
              ...
              market conditions. Property taxes in Austin and Central Texas vary by jurisdiction.
              Contact a lender for accurate pre-approval and payment information.
            </p>
          </div>
        </Container>
      </Section>
