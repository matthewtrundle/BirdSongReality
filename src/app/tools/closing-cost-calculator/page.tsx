...
export default function ClosingCostCalculatorPage() {
  ...
  const calculations = useMemo(() => {
    ...
    if (isBuyer) {
      ...
      const prepaidInsurance = 4000 // 1 year upfront
      const prepaidTaxes = (purchasePrice * 0.02) / 12 * 3 // 3 months escrow
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Estimate your closing costs when buying or selling in Austin"
      ...
      <Container>
        <CTABanner
          title={isBuyer ? "Find Your Austin Home" : "Sell Your Property"}
          description={
            isBuyer
              ? "Browse available properties in Austin"
