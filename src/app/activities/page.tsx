...
export const metadata: Metadata = {
  title: "Things to Do in Austin | Activities & Recreation",
  description:
    "Discover the best activities in Austin, Texas. From hiking and live music to kayaking and exploring, find your perfect Austin adventure.",
  keywords: [
    "things to do Austin",
    "Austin activities",
    "Austin outdoor recreation",
    "activities Austin Texas",
    "Austin recreation",
  ],
}
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="From world-class live music to scenic hikes and waterfront adventures, discover activities for every interest"
