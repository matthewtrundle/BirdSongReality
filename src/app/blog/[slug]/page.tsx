...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <>
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 mt-6 pt-6 border-t border-neutral-200">
                <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center">
                  <span className="text-primary-600 font-semibold text-lg">BR</span>
                </div>
                <div>
            ...
            <div className="mt-8 p-6 bg-primary-50 rounded-xl">
              <div className="text-center">
                ...
                <p className="text-neutral-600 text-sm mb-4">
                  Share this article with someone who&apos;s considering Austin real estate.
                </p>
      ...
      <LeadFormSection
        variant="dark"
        title="Ready to Find Your Austin Property?"
        subtitle="Let our experts help you navigate the Austin real estate market."
      />
    </>
  )
}
