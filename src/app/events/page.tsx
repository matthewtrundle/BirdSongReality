...
export const metadata: Metadata = {
  title: "Events & Festivals in Austin | Annual Events Calendar",
  description:
    "Discover Austin events and festivals. From SXSW to Austin City Limits, find annual events, food festivals, and holiday celebrations.",
  keywords: [
    "Austin events",
    "SXSW Austin",
    "Austin City Limits",
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Year-round celebrations, festivals, and community gatherings in Austin"
