...
export const metadata: Metadata = {
  title: "Local Places in Austin | Restaurants, Shops, Attractions",
  description:
    "Discover the best local places in Austin, Texas. Explore restaurants, bars, shops, attractions, and outdoor spots in our comprehensive guide.",
  keywords: [
    "Austin restaurants",
    "Austin bars",
    "Austin shops",
...
export default function PlacesPage() {
  ...
  return (
    <>
      <SEOPageHero
        title="Local Places in Austin"
        subtitle="Your guide to the best restaurants, bars, shops, and attractions in Austin"
