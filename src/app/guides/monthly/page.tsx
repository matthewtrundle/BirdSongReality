...
export const metadata: Metadata = {
  title: "Austin Monthly Guide | Best Time to Visit & Move",
  description:
    "Plan your perfect Austin experience with our monthly guides. Learn about weather, events, crowds, and activities for each month of the year.",
  keywords: [
    "Austin weather",
    "best time to visit Austin",
    "Austin monthly guide",
    "when to visit Austin TX",
    "Austin seasons",
  ],
}
...
export default function MonthlyGuidesPage() {
  ...
  return (
    <>
      <SEOPageHero
        title="Monthly Guides to Austin"
        subtitle="Plan the perfect visit or move with our month-by-month guide to weather, events, and activities"
