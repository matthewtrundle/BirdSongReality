...
export const metadata: Metadata = {
  ...
  description: "Explore our interactive tools and features for Austin real estate",
}
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Explore our tools designed to help you find your perfect Austin home"
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              ...
              />
              <p className="mt-4 text-center text-sm text-neutral-600">Kitchen Remodel - Tarrytown</p>
            </div>
            <div>
              <BeforeAfterSlider
                ...
                afterLabel="After"
              />
              <p className="mt-4 text-center text-sm text-neutral-600">Living Room Update - Zilker</p>
            </div>
          </div>
        </Container>
      </Section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-neutral-600 mb-6">
                ...
                criteria hit the market. In the competitive Austin market, timing is everything.
              </p>
