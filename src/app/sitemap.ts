...
const BASE_URL = "https://birdsongrealtyteam.com"
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/austin-luxury-homes`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE_URL}/austin-new-construction`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE_URL}/austin-waterfront-homes`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE_URL}/austin-condos-townhomes`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/austin-investment-properties`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/austin-relocation`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/austin-first-time-buyers`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/seller-services`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/guides/buying-in-austin`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/guides/financing-austin-property`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/guides/investment-property`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/guides/relocating-to-austin`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/living-in-austin`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
