...
export const metadata: Metadata = {
  title: "Austin Comparisons | Compare Neighborhoods & Real Estate Options",
  description:
    "Compare Austin neighborhoods and explore real estate options. Find out which area of Austin is right for you with our detailed comparison guides.",
  keywords: [
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Detailed comparisons to help you make the right choice about Austin"
