...
export const metadata: Metadata = {
  title: "Best of Austin | Top Restaurants, Parks & More",
  description:
    "Discover the best of Austin with our curated guides. Find the top restaurants, parks, bars, live music venues, and more in Austin.",
  keywords: [
  ...
  return (
    <>
      <SEOPageHero
        ...
        subtitle="Curated guides to the best restaurants, parks, bars, and attractions in Austin"
