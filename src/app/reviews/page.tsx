...
export const metadata: Metadata = {
  ...
  description:
    "Read what our clients say about working with Birdsong Realty Team. 5-star reviews from happy homebuyers, sellers, and investors across Austin and Central Texas.",
  keywords: [
    "Birdsong Realty Team reviews",
    "Austin real estate agent reviews",
    "best realtor Austin TX",
    "Austin real estate testimonials",
  ],
  openGraph: {
    title: "Client Reviews & Testimonials | Birdsong Realty Team",
    description: "Read what our clients say about working with Birdsong Realty Team.",
  },
}
  ...
  return (
    <>
      ...
      <SEOPageHero
        ...
        subtitle="Hear from real clients who found their perfect Austin property with us."
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8">
              <div className="p-6">
                ...
                <p className="text-neutral-600 text-sm">
                  Deep knowledge of Austin neighborhoods, pricing, and market trends.
                </p>
              </div>
              <div className="p-6">
                <div className="w-12 h-12 mx-auto mb-4 bg-primary-100 rounded-full flex items-center justify-center">
      ...
      <LeadFormSection
        ...
        subtitle="Join our list of happy clients. Let's start your Austin home search."
      />
    </>
  )
}
