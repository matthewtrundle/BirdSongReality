      ...
      <div className="bg-white rounded-xl shadow-xl border border-neutral-200/80 overflow-hidden">
        ...
        <div className="bg-primary-900 px-5 py-3.5 text-white relative">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-md bg-highlight-500/20 flex items-center justify-center">
              <svg className="w-4 h-4 text-highlight-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
