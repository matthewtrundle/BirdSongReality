...
const timelineSteps = [
  {
    ...
    duration: "1-3 days",
    description: "Connect with a lender to understand your buying power. We can recommend trusted local lenders who specialize in Austin area properties.",
    tips: [
  ...
  },
  {
    ...
    duration: "1-2 days",
    description: "Work with us to identify your must-haves: neighborhood, school district, number of bedrooms, outdoor space, commute time, and more.",
    tips: [
      "Consider primary residence vs. investment",
      "Research HOA rules and neighborhood covenants",
  ...
  },
  {
    ...
    tips: [
      ...
      "Check out nearby amenities and parks",
  ...
  },
  {
    ...
    tips: [
      "Order homeowner's insurance quotes early",
  ...
  },
  {
    ...
    duration: "1 day",
    description: "Sign the final paperwork, receive your keys, and welcome to your new Austin home!",
    tips: [
