...
const stats = [
  ...
  { value: 85, prefix: "$", suffix: "M+", label: "Closed Volume" },
      ...
      <Container className="relative">
        <div ref={sectionRef} className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              The Austin market is dynamic. With strong buyer demand
              and a thriving economy, now could be the perfect time to maximize
