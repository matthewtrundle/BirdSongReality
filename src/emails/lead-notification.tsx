  ...
  return (
    <BaseLayout previewText={previewText}>
      ...
      <Section style={actionsSection}>
        <Button style={primaryButton} href={`mailto:${email}?subject=Re: Your Austin Property Inquiry - Birdsong Realty Team`}>
      ...
      <Section style={footerNote}>
        <Text style={footerNoteText}>
          This lead was submitted through the Birdsong Realty Team website.
