  ...
  return (
    <BaseLayout previewText={previewText}>
      ...
      <Text style={paragraph}>
        ...
        request. Patrick Birdsong or a member of the Birdsong Realty Team will be in
      ...
      <Section style={ctaSection}>
        ...
        <Button style={primaryButton} href="https://birdsongrealtyteam.com/portfolio">
          View Our Portfolio
        </Button>
        <Button style={secondaryButton} href="https://birdsongrealtyteam.com/guides">
          Browse Buyer Guides
        </Button>
      </Section>
      ...
      <Section style={signatureSection}>
        <Text style={signatureText}>
          Looking forward to helping you find your perfect Austin home!
        </Text>
        <Text style={signatureName}>
          Patrick Birdsong &amp; The Birdsong Realty Team
        </Text>
      </Section>
    </BaseLayout>
  )
